...
namespace ezg {
	...
	void MushroomRed::_setAnimations_() /*override*/ {
		...
		m_animation.addFrame(static_cast<int>(EntityAnimation::Attack), sf::IntRect(33, 30, 6, 2), 100.f);
		m_animation.addFrame(static_cast<int>(EntityAnimation::Attack), sf::IntRect(41, 29, 6, 3), 200.f);
		m_animation.addFrame(static_cast<int>(EntityAnimation::Attack), sf::IntRect(49, 27, 6, 5), 200.f);
		m_animation.addFrame(static_cast<int>(EntityAnimation::Attack), sf::IntRect(57, 26, 6, 6), 400.f);
		m_animation.addFrame(static_cast<int>(EntityAnimation::Attack), sf::IntRect(49, 27, 6, 5), 200.f);
		m_animation.addFrame(static_cast<int>(EntityAnimation::Attack), sf::IntRect(41, 29, 6, 3), 200.f);
		m_animation.addFrame(static_cast<int>(EntityAnimation::Attack), sf::IntRect(33, 30, 6, 2), 100.f);
	}
