...
namespace ezg {
	...
	void MushroomBlue::_setAnimations_() /*override*/ {
		...
		m_animation.addFrame(static_cast<int>(Animation::Idle), sf::IntRect(1, 38, 6, 2), 1000000.f);

		m_animation.addAnimation(static_cast<int>(Animation::Attack));
		m_animation.addFrame(static_cast<int>(Animation::Attack), sf::IntRect(33, 38, 6, 2), 0.1f);
		m_animation.addFrame(static_cast<int>(Animation::Attack), sf::IntRect(41, 37, 6, 3), 0.2f);
		m_animation.addFrame(static_cast<int>(Animation::Attack), sf::IntRect(49, 35, 6, 5), 0.2f);
		m_animation.addFrame(static_cast<int>(Animation::Attack), sf::IntRect(57, 34, 6, 6), 0.4f);
		m_animation.addFrame(static_cast<int>(Animation::Attack), sf::IntRect(49, 35, 6, 5), 0.2f);
		m_animation.addFrame(static_cast<int>(Animation::Attack), sf::IntRect(41, 37, 6, 3), 0.2f);
		m_animation.addFrame(static_cast<int>(Animation::Attack), sf::IntRect(33, 38, 6, 2), 0.1f);
